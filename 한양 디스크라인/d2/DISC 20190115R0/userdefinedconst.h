...
#define			MAX_CH					24
#define			DISP_CH					24
#define			MAX_MANU_SW				60  // 수동조작 스위치 숫자
...
#define	PLCWordReadNo			100 		   					// 한번 읽어 올 총 워드수  최대 32 word
#define	PLCWordWriteStNo		20		   					// 
#define	PLCWordWriteNo			50		   					// 한번 쓸수 있는 워드수 최대 10word
