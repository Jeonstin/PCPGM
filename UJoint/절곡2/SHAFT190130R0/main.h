...
#define  MAINPANEL_LG_3                   86      /* control type: numeric, callback function: (none) */
#define  MAINPANEL_LG_2                   87      /* control type: numeric, callback function: (none) */
#define  MAINPANEL_LG                     88      /* control type: numeric, callback function: (none) */
#define  MAINPANEL_GNG_3                  89      /* control type: textButton, callback function: (none) */
#define  MAINPANEL_GNG_2                  90      /* control type: textButton, callback function: (none) */
#define  MAINPANEL_GNG                    91      /* control type: textButton, callback function: (none) */
#define  MAINPANEL_DATETIME               92      /* control type: timer, callback function: cbDateTime */
#define  MAINPANEL_PLCTIMER               93      /* control type: timer, callback function: PlcTimer */
#define  MAINPANEL_AMPTIMER               94      /* control type: timer, callback function: AmpTimer */
#define  MAINPANEL_TESTTIME               95      /* control type: timer, callback function: TestTime */
#define  MAINPANEL_SPCLEFT                96      /* control type: ring, callback function: SPCSelect */
...
#define  MAINPANEL_LED_OUT_2              104     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_OUT_1              105     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_IN_2               106     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_10            107     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_9             108     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_8             109     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_7             110     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_6             111     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_5             112     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_4             113     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_3             114     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_2             115     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_1             116     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_IN_1               117     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_4                  118     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LSL                    119     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_LCL                    120     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_UCL                    121     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_DECORATION_2           122     /* control type: deco, callback function: (none) */
#define  MAINPANEL_USL                    123     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_CH_S2                  124     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_WORK_MODEL_CHAR        125     /* control type: string, callback function: (none) */
#define  MAINPANEL_WORK_NAME              126     /* control type: string, callback function: (none) */
#define  MAINPANEL_STRING_3               127     /* control type: string, callback function: (none) */
#define  MAINPANEL_STRING                 128     /* control type: string, callback function: (none) */
#define  MAINPANEL_CH_S1                  129     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_LAN_TIMER              130     /* control type: timer, callback function: LanTimer */
#define  MAINPANEL_SPLITTER_5             131     /* control type: splitter, callback function: (none) */
#define  MAINPANEL_GRAPH6                 132     /* control type: graph, callback function: Graph1 */
#define  MAINPANEL_GRAPH5                 133     /* control type: graph, callback function: Graph1 */
...
#define  MAINPANEL_ERRVIEW                138     /* control type: command, callback function: ErrView */
#define  MAINPANEL_A_START                139     /* control type: command, callback function: A_Start */
#define  MAINPANEL_KEYBOARD               140     /* control type: command, callback function: Keyboard */
#define  MAINPANEL_LISTBOX                141     /* control type: listBox, callback function: (none) */
#define  MAINPANEL_A_TABLE_3              142     /* control type: table, callback function: (none) */
#define  MAINPANEL_SCAN_DATA              143     /* control type: string, callback function: (none) */
#define  MAINPANEL_TEXT_DATA_3            144     /* control type: string, callback function: (none) */
#define  MAINPANEL_TEXT_DATA_2            145     /* control type: string, callback function: (none) */
#define  MAINPANEL_TEXT_DATA_1            146     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_7             147     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_6             148     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_5             149     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_3             150     /* control type: string, callback function: (none) */
#define  MAINPANEL_STRING_2               151     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_2             152     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_4             153     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA               154     /* control type: string, callback function: (none) */
#define  MAINPANEL_A_TABLE_2              155     /* control type: table, callback function: (none) */
#define  MAINPANEL_A_TABLE                156     /* control type: table, callback function: A_Table */
#define  MAINPANEL_SPLITTER_15            157     /* control type: splitter, callback function: (none) */
#define  MAINPANEL_SPLITTER               158     /* control type: splitter, callback function: (none) */
#define  MAINPANEL_IMAGE_CAP              159     /* control type: command, callback function: Image_Cap */
#define  MAINPANEL_LAN_TRANS              160     /* control type: command, callback function: Lan_Trans */
#define  MAINPANEL_COMP_VALUE             161     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_RINGCH                 162     /* control type: string, callback function: (none) */
#define  MAINPANEL_TEXTMSG_4              163     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_3              164     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_DECORATION_3           165     /* control type: deco, callback function: (none) */
#define  MAINPANEL_TAB                    166     /* control type: tab, callback function: (none) */
#define  MAINPANEL_DECO_2                 167     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECO_1                 168     /* control type: deco, callback function: (none) */
#define  MAINPANEL_A_WORK3                169     /* control type: LED, callback function: (none) */
#define  MAINPANEL_A_WORK2                170     /* control type: LED, callback function: (none) */
#define  MAINPANEL_A_WORK1                171     /* control type: LED, callback function: (none) */
#define  MAINPANEL_SELECT_MEAS            172     /* control type: textButton, callback function: Select_Meas */
#define  MAINPANEL_SELECT_NG_INT          173     /* control type: textButton, callback function: Sw_Int */
#define  MAINPANEL_LED_MC_3               174     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED                    175     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_MC_4               176     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_MC_2               177     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_2                  178     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_MC_1               179     /* control type: LED, callback function: (none) */
#define  MAINPANEL_DECORATION_5           180     /* control type: deco, callback function: (none) */
#define  MAINPANEL_MARKLED                181     /* control type: LED, callback function: (none) */
#define  MAINPANEL_MENU_BT                182     /* control type: command, callback function: Menu_Bt */
#define  MAINPANEL_RESULTVIEW0            183     /* control type: command, callback function: ResultView0 */
#define  MAINPANEL_MODELSETUP0            184     /* control type: command, callback function: ModelSetup0 */
#define  MAINPANEL_ZEROSETUP0             185     /* control type: command, callback function: ZeroSetup0 */
#define  MAINPANEL_MANUALCTRL0            186     /* control type: command, callback function: ManualCtrl0 */
#define  MAINPANEL_MARKING_CHAR           187     /* control type: string, callback function: (none) */
#define  MAINPANEL_BF_MARKING             188     /* control type: string, callback function: (none) */
#define  MAINPANEL_DECORATION_7           189     /* control type: deco, callback function: (none) */
#define  MAINPANEL_TEXTMSG_5              190     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_9              191     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_MENU_BT1               192     /* control type: command, callback function: Menu_Bt */
#define  MAINPANEL_A_DATAVIEW             193     /* control type: command, callback function: A_Dataview */
#define  MAINPANEL_LIST_STATUS            194     /* control type: command, callback function: List_Status */
#define  MAINPANEL_RESULTVIEW1            195     /* control type: command, callback function: ResultView0 */
#define  MAINPANEL_MODELSETUP1            196     /* control type: command, callback function: ModelSetup0 */
#define  MAINPANEL_ZEROSETUP1             197     /* control type: command, callback function: ZeroSetup0 */
#define  MAINPANEL_MANUALCTRL_2           198     /* control type: command, callback function: ManualCtrl_2 */
#define  MAINPANEL_CLOSE                  199     /* control type: command, callback function: Close */
#define  MAINPANEL_MANUALCTRL1            200     /* control type: command, callback function: ManualCtrl0 */
#define  MAINPANEL_RING                   201     /* control type: ring, callback function: (none) */
#define  MAINPANEL_DECORATION_8           202     /* control type: deco, callback function: (none) */
#define  MAINPANEL_ENC                    203     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_NICK_LED               204     /* control type: LED, callback function: (none) */
#define  MAINPANEL_DATA_TABLE             205     /* control type: table, callback function: (none) */
#define  MAINPANEL_INWORK_COUNT           206     /* control type: numeric, callback function: Inwork_Count */
#define  MAINPANEL_MCID_VIEW              207     /* control type: ring, callback function: Mcid_View */
#define  MAINPANEL_DECORATION_9           208     /* control type: deco, callback function: (none) */
#define  MAINPANEL_CWSCR                  209     /* control type: binary, callback function: Cwscr */
#define  MAINPANEL_NG_VIEW                210     /* control type: binary, callback function: Ng_View */
#define  MAINPANEL_PICTURE_2              211     /* control type: picture, callback function: (none) */
#define  MAINPANEL_MODEL_TL               212     /* control type: textButton, callback function: (none) */
#define  MAINPANEL_MODEL_EPB              213     /* control type: textButton, callback function: (none) */
#define  MAINPANEL_MODEL_WD               214     /* control type: textButton, callback function: (none) */
#define  MAINPANEL_MODEL_LR               215     /* control type: textButton, callback function: (none) */
#define  MAINPANEL_NET_DATA               216     /* control type: string, callback function: (none) */
#define  MAINPANEL_LED_3                  217     /* control type: LED, callback function: (none) */
#define  MAINPANEL_RING_2                 218     /* control type: ring, callback function: View_DTV */
#define  MAINPANEL_FAIL_CNT               219     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_ALARM_DELETE           220     /* control type: command, callback function: Alarm_Delete */
#define  MAINPANEL_ALARM_LIST             221     /* control type: textBox, callback function: (none) */
#define  MAINPANEL_STATUS_BOX             222     /* control type: listBox, callback function: (none) */
#define  MAINPANEL_DECORATION             223     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_10          224     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_12          225     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_11          226     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_4           227     /* control type: deco, callback function: (none) */
#define  MAINPANEL_OPERATE_NO             228     /* control type: ring, callback function: Operate_No */
#define  MAINPANEL_RESET_MC               229     /* control type: command, callback function: Reset_Mc */
#define  MAINPANEL_LED_6                  230     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_5                  231     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_7                  232     /* control type: LED, callback function: (none) */
#define  MAINPANEL_HHMMSS_3               233     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_HHMMSS_4               234     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_MMDDYY                 235     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_HHMMSS                 236     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_18             237     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_LED_8                  238     /* control type: LED, callback function: (none) */
#define  MAINPANEL_ZERO_NOW               239     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_TEXTMSG_7              240     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_6              241     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_ZERO_CNT               242     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_PICTURE                243     /* control type: picture, callback function: MeasPointEvent */
#define  MAINPANEL_DECORATION_6           244     /* control type: deco, callback function: (none) */
#define  MAINPANEL_B2                     245     /* control type: string, callback function: B2_Select */
#define  MAINPANEL_B1                     246     /* control type: string, callback function: B1_Select */
