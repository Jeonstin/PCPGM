		...
		void *callbackData, int eventData1, int eventData2)
{
	switch (event)
	{
		case EVENT_LEFT_CLICK:
// 					GetCtrlVal(interdata, INTPANEL_ENC_PLS_NUM, &EncPlsNum);
 					callKEYPAD(panel, control, event, NON_TABLE, &Data_Weight,0);
...
int CVICALLBACK Shaft2_Ldata (int panel, int control, int event,
		void *callbackData, int eventData1, int eventData2)
{
	switch (event)
	{
		case EVENT_LEFT_CLICK:
 					callKEYPAD(panel, control, event, NON_TABLE, &Shaft2_Low,0);
			break;
	}
	return 0;
}

int CVICALLBACK Shaft2_Hdata (int panel, int control, int event,
		void *callbackData, int eventData1, int eventData2)
{
	switch (event)
	{
		case EVENT_LEFT_CLICK:
 					callKEYPAD(panel, control, event, NON_TABLE, &Shaft2_High,0);
			break;
	}
	return 0;
}

int CVICALLBACK Tube2_Ldata (int panel, int control, int event,
		void *callbackData, int eventData1, int eventData2)
{
	switch (event)
	{
		case EVENT_LEFT_CLICK:
 					callKEYPAD(panel, control, event, NON_TABLE, &Tube2_Low,0);
			break;
	}
	return 0;
}

int CVICALLBACK Tube2_Hdata (int panel, int control, int event,
		void *callbackData, int eventData1, int eventData2)
{
	switch (event)
	{
		case EVENT_LEFT_CLICK:
 					callKEYPAD(panel, control, event, NON_TABLE, &Tube2_High,0);
			break;
	}
	return 0;
}
...
int CVICALLBACK M_Data_Weight (int panel, int control, int event,
		void *callbackData, int eventData1, int eventData2)
{
	switch (event)
	{
		case EVENT_LEFT_CLICK:
 					callKEYPAD(panel, control, event, NON_TABLE, &Data_Weight2,0);
			break;
	}
	return 0;
}

int CVICALLBACK M_Data_Weight3 (int panel, int control, int event,
		void *callbackData, int eventData1, int eventData2)
{
	switch (event)
	{
		case EVENT_LEFT_CLICK:
 					callKEYPAD(panel, control, event, NON_TABLE, &Data_Weight3,0);
			break;
	}
	return 0;
}

int CVICALLBACK M_Data_Weight4 (int panel, int control, int event,
		void *callbackData, int eventData1, int eventData2)
{
	switch (event)
	{
		case EVENT_LEFT_CLICK:
 					callKEYPAD(panel, control, event, NON_TABLE, &Data_Weight4,0);
			break;
	}
	return 0;
}

int CVICALLBACK M_Data_Weight5 (int panel, int control, int event,
		void *callbackData, int eventData1, int eventData2)
{
	switch (event)
	{
		case EVENT_LEFT_CLICK:
 					callKEYPAD(panel, control, event, NON_TABLE, &Data_Weight5,0);
			break;
	}
	return 0;
}
