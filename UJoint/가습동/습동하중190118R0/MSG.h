...
#define  WORKREF_SHAFT_LOW                30      /* control type: numeric, callback function: Shaft_Ldata */
#define  WORKREF_TEXTMSG                  31      /* control type: textMsg, callback function: (none) */
#define  WORKREF_TEXTMSG_2                32      /* control type: textMsg, callback function: (none) */
#define  WORKREF_DECORATION               33      /* control type: deco, callback function: (none) */
...
#define  WORKREF_DECORATION_12            37      /* control type: deco, callback function: (none) */
