...
#define			MAX_CH					28
#define			DISP_CH					28
#define			MAX_MANU_SW				45  // 수동조작 스위치 숫자
...
#define			OLD							3
#define			LATEST						4
#define			Z_DIFFERENCE				5
#define			N_ALLOWED_DIFF				6
#define			P_ALLOWED_DIFF				7
#define			SENSOR_NAME					8
...
#define			MODEL_COMP_COL				6
#define			MODEL_NTOL_COL				2
#define			MODEL_NCTOL_COL				3
#define			MODEL_PCTOL_COL				4
#define			MODEL_PTOL_COL				5
#define			MODEL_NMTOL_COL				7
#define			MODEL_PMTOL_COL				8


#define			MODEL_NM2TOL_COL				9
#define			MODEL_PM2TOL_COL				10
...
#define			PGM_NMTOL_COL				15
#define			PGM_PMTOL_COL				16
#define			PGM_NM2TOL_COL				13
#define			PGM_PM2TOL_COL				14
...
#define			PLC_SELECTION			MELSEC
	...
	#define	PLCReadAddr				"M*017000"    		// M 10진수로 16의 배수로 설정할것. 기타는 상관없음    
	#define	PLCWriteAddr			"M*017320"    
...
#define	PLCWordReadNo			50 		   					// 한번 읽어 올 총 워드수  최대 32 word
#define	PLCWordWriteStNo		20		   					// 
#define	PLCWordWriteNo			10		   					// 한번 쓸수 있는 워드수 최대 10word
