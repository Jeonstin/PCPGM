...
#define  INTPANEL_STOREVALIDDAY1          7       /* control type: numeric, callback function: Keypad */
...
#define  WORKREF_TUBE_HIGH                27      /* control type: numeric, callback function: Tube_Hdata */
#define  WORKREF_TUBE_LOW                 28      /* control type: numeric, callback function: Tube_Ldata */
#define  WORKREF_SHAFT_HIGH               29      /* control type: numeric, callback function: Shaft_Hdata */
#define  WORKREF_RETRY_SET_VALUE          30      /* control type: numeric, callback function: (none) */
#define  WORKREF_SHAFT_LOW                31      /* control type: numeric, callback function: Shaft_Ldata */
#define  WORKREF_TEXTMSG                  32      /* control type: textMsg, callback function: (none) */
#define  WORKREF_TEXTMSG_2                33      /* control type: textMsg, callback function: (none) */
#define  WORKREF_DECORATION               34      /* control type: deco, callback function: (none) */
#define  WORKREF_TEXTMSG_3                35      /* control type: textMsg, callback function: (none) */
#define  WORKREF_YAXIS_HIGH               36      /* control type: numeric, callback function: Yaxis_High */
#define  WORKREF_YAXIS_LOW                37      /* control type: numeric, callback function: Yaxis_Low */
#define  WORKREF_DECORATION_12            38      /* control type: deco, callback function: (none) */
