...
#define  MAINPANEL_LG                     85      /* control type: numeric, callback function: (none) */
#define  MAINPANEL_GNG_3                  86      /* control type: textButton, callback function: (none) */
#define  MAINPANEL_GNG_2                  87      /* control type: textButton, callback function: (none) */
#define  MAINPANEL_GNG                    88      /* control type: textButton, callback function: (none) */
#define  MAINPANEL_DATETIME               89      /* control type: timer, callback function: cbDateTime */
#define  MAINPANEL_PLCTIMER               90      /* control type: timer, callback function: PlcTimer */
#define  MAINPANEL_AMPTIMER               91      /* control type: timer, callback function: AmpTimer */
#define  MAINPANEL_TESTTIME               92      /* control type: timer, callback function: TestTime */
#define  MAINPANEL_SPCLEFT                93      /* control type: ring, callback function: SPCSelect */
#define  MAINPANEL_TEXTMSG                94      /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_STATUSMSG_5            95      /* control type: string, callback function: (none) */
#define  MAINPANEL_STATUSMSG_4            96      /* control type: string, callback function: (none) */
#define  MAINPANEL_STATUSMSG_3            97      /* control type: string, callback function: (none) */
#define  MAINPANEL_STATUSMSG_2            98      /* control type: string, callback function: (none) */
#define  MAINPANEL_STATUSMSG              99      /* control type: string, callback function: (none) */
#define  MAINPANEL_MEASDATATABLE          100     /* control type: table, callback function: (none) */
#define  MAINPANEL_LED_OUT_2              101     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_OUT_1              102     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_IN_2               103     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_10            104     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_9             105     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_8             106     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_7             107     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_6             108     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_5             109     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_4             110     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_3             111     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_2             112     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_DATA_1             113     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_IN_1               114     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_4                  115     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LSL                    116     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_LCL                    117     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_UCL                    118     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_DECORATION_2           119     /* control type: deco, callback function: (none) */
#define  MAINPANEL_USL                    120     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_CH_S2                  121     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_WORK_MODEL_CHAR        122     /* control type: string, callback function: (none) */
#define  MAINPANEL_WORK_NAME              123     /* control type: string, callback function: (none) */
#define  MAINPANEL_STRING_3               124     /* control type: string, callback function: (none) */
#define  MAINPANEL_STRING                 125     /* control type: string, callback function: (none) */
#define  MAINPANEL_CH_S1                  126     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_LAN_TIMER              127     /* control type: timer, callback function: LanTimer */
#define  MAINPANEL_SPLITTER_5             128     /* control type: splitter, callback function: (none) */
#define  MAINPANEL_GRAPH6                 129     /* control type: graph, callback function: Graph1 */
#define  MAINPANEL_GRAPH5                 130     /* control type: graph, callback function: Graph1 */
#define  MAINPANEL_GRAPH4                 131     /* control type: graph, callback function: Graph1 */
#define  MAINPANEL_GRAPH3                 132     /* control type: graph, callback function: Graph1 */
#define  MAINPANEL_GRAPH2                 133     /* control type: graph, callback function: Graph1 */
#define  MAINPANEL_GRAPH1                 134     /* control type: graph, callback function: Graph1 */
#define  MAINPANEL_ERRVIEW                135     /* control type: command, callback function: ErrView */
#define  MAINPANEL_A_START                136     /* control type: command, callback function: A_Start */
#define  MAINPANEL_KEYBOARD               137     /* control type: command, callback function: Keyboard */
#define  MAINPANEL_LISTBOX                138     /* control type: listBox, callback function: (none) */
#define  MAINPANEL_A_TABLE_3              139     /* control type: table, callback function: (none) */
#define  MAINPANEL_SCAN_DATA              140     /* control type: string, callback function: (none) */
#define  MAINPANEL_TEXT_DATA_3            141     /* control type: string, callback function: (none) */
#define  MAINPANEL_TEXT_DATA_2            142     /* control type: string, callback function: (none) */
#define  MAINPANEL_TEXT_DATA_1            143     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_7             144     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_6             145     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_5             146     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_3             147     /* control type: string, callback function: (none) */
#define  MAINPANEL_STRING_2               148     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_2             149     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_4             150     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA               151     /* control type: string, callback function: (none) */
#define  MAINPANEL_A_TABLE_2              152     /* control type: table, callback function: (none) */
#define  MAINPANEL_A_TABLE                153     /* control type: table, callback function: A_Table */
#define  MAINPANEL_SPLITTER_15            154     /* control type: splitter, callback function: (none) */
#define  MAINPANEL_SPLITTER               155     /* control type: splitter, callback function: (none) */
#define  MAINPANEL_IMAGE_CAP              156     /* control type: command, callback function: Image_Cap */
#define  MAINPANEL_LAN_TRANS              157     /* control type: command, callback function: Lan_Trans */
#define  MAINPANEL_COMP_VALUE             158     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_RINGCH                 159     /* control type: string, callback function: (none) */
#define  MAINPANEL_TEXTMSG_4              160     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_3              161     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_DECORATION_3           162     /* control type: deco, callback function: (none) */
#define  MAINPANEL_TAB                    163     /* control type: tab, callback function: (none) */
#define  MAINPANEL_DECO_2                 164     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECO_1                 165     /* control type: deco, callback function: (none) */
#define  MAINPANEL_A_WORK3                166     /* control type: LED, callback function: (none) */
#define  MAINPANEL_A_WORK2                167     /* control type: LED, callback function: (none) */
#define  MAINPANEL_A_WORK1                168     /* control type: LED, callback function: (none) */
#define  MAINPANEL_SELECT_MEAS            169     /* control type: textButton, callback function: Select_Meas */
#define  MAINPANEL_SELECT_NG_INT          170     /* control type: textButton, callback function: Sw_Int */
#define  MAINPANEL_LED_MC_3               171     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED                    172     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_MC_4               173     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_MC_2               174     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_2                  175     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_MC_1               176     /* control type: LED, callback function: (none) */
#define  MAINPANEL_DECORATION_5           177     /* control type: deco, callback function: (none) */
#define  MAINPANEL_MARKLED                178     /* control type: LED, callback function: (none) */
#define  MAINPANEL_MENU_BT                179     /* control type: command, callback function: Menu_Bt */
#define  MAINPANEL_RESULTVIEW0            180     /* control type: command, callback function: ResultView0 */
#define  MAINPANEL_MODELSETUP0            181     /* control type: command, callback function: ModelSetup0 */
#define  MAINPANEL_ZEROSETUP0             182     /* control type: command, callback function: ZeroSetup0 */
#define  MAINPANEL_MANUALCTRL0            183     /* control type: command, callback function: ManualCtrl0 */
#define  MAINPANEL_MARKING_CHAR           184     /* control type: string, callback function: (none) */
#define  MAINPANEL_BF_MARKING             185     /* control type: string, callback function: (none) */
#define  MAINPANEL_DECORATION_7           186     /* control type: deco, callback function: (none) */
#define  MAINPANEL_TEXTMSG_5              187     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_9              188     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_MENU_BT1               189     /* control type: command, callback function: Menu_Bt */
#define  MAINPANEL_A_DATAVIEW             190     /* control type: command, callback function: A_Dataview */
#define  MAINPANEL_LIST_STATUS            191     /* control type: command, callback function: List_Status */
#define  MAINPANEL_RESULTVIEW1            192     /* control type: command, callback function: ResultView0 */
#define  MAINPANEL_MODELSETUP1            193     /* control type: command, callback function: ModelSetup0 */
#define  MAINPANEL_ZEROSETUP1             194     /* control type: command, callback function: ZeroSetup0 */
#define  MAINPANEL_MANUALCTRL_2           195     /* control type: command, callback function: ManualCtrl_2 */
#define  MAINPANEL_CLOSE                  196     /* control type: command, callback function: Close */
#define  MAINPANEL_MANUALCTRL1            197     /* control type: command, callback function: ManualCtrl0 */
#define  MAINPANEL_RING                   198     /* control type: ring, callback function: (none) */
#define  MAINPANEL_DECORATION_8           199     /* control type: deco, callback function: (none) */
#define  MAINPANEL_ENC                    200     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_NICK_LED               201     /* control type: LED, callback function: (none) */
#define  MAINPANEL_DATA_TABLE             202     /* control type: table, callback function: (none) */
#define  MAINPANEL_INWORK_COUNT           203     /* control type: numeric, callback function: Inwork_Count */
#define  MAINPANEL_MCID_VIEW              204     /* control type: ring, callback function: Mcid_View */
#define  MAINPANEL_DECORATION_9           205     /* control type: deco, callback function: (none) */
#define  MAINPANEL_CWSCR                  206     /* control type: binary, callback function: Cwscr */
#define  MAINPANEL_NG_VIEW                207     /* control type: binary, callback function: Ng_View */
#define  MAINPANEL_PICTURE_2              208     /* control type: picture, callback function: (none) */
#define  MAINPANEL_MODEL_TL               209     /* control type: textButton, callback function: (none) */
#define  MAINPANEL_MODEL_EPB              210     /* control type: textButton, callback function: (none) */
#define  MAINPANEL_MODEL_WD               211     /* control type: textButton, callback function: (none) */
#define  MAINPANEL_MODEL_LR               212     /* control type: textButton, callback function: (none) */
#define  MAINPANEL_NET_DATA               213     /* control type: string, callback function: (none) */
#define  MAINPANEL_LED_3                  214     /* control type: LED, callback function: (none) */
#define  MAINPANEL_RING_2                 215     /* control type: ring, callback function: View_DTV */
#define  MAINPANEL_FAIL_CNT               216     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_ALARM_DELETE           217     /* control type: command, callback function: Alarm_Delete */
#define  MAINPANEL_ALARM_LIST             218     /* control type: textBox, callback function: (none) */
#define  MAINPANEL_STATUS_BOX             219     /* control type: listBox, callback function: (none) */
#define  MAINPANEL_DECORATION             220     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_10          221     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_12          222     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_11          223     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_4           224     /* control type: deco, callback function: (none) */
#define  MAINPANEL_OPERATE_NO             225     /* control type: ring, callback function: Operate_No */
#define  MAINPANEL_RESET_MC               226     /* control type: command, callback function: Reset_Mc */
#define  MAINPANEL_LED_6                  227     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_5                  228     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_7                  229     /* control type: LED, callback function: (none) */
#define  MAINPANEL_HHMMSS_3               230     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_HHMMSS_4               231     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_MMDDYY                 232     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_HHMMSS                 233     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_18             234     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_LED_8                  235     /* control type: LED, callback function: (none) */
#define  MAINPANEL_ZERO_NOW               236     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_TEXTMSG_7              237     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_6              238     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_ZERO_CNT               239     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_PICTURE                240     /* control type: picture, callback function: MeasPointEvent */
#define  MAINPANEL_DECORATION_6           241     /* control type: deco, callback function: (none) */
#define  MAINPANEL_B2                     242     /* control type: string, callback function: B2_Select */
#define  MAINPANEL_B1                     243     /* control type: string, callback function: B1_Select */
