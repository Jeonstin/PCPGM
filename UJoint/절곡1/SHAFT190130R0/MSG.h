...
#define  WORKREF_M_DATA_WEIGHT_5          48      /* control type: numeric, callback function: M_Data_Weight5 */
#define  WORKREF_M_DATA_WEIGHT_4          49      /* control type: numeric, callback function: M_Data_Weight4 */
#define  WORKREF_M_DATA_WEIGHT_3          50      /* control type: numeric, callback function: M_Data_Weight3 */
#define  WORKREF_M_DATA_WEIGHT            51      /* control type: numeric, callback function: M_Data_Weight */
#define  WORKREF_DECORATION_13            52      /* control type: deco, callback function: (none) */
