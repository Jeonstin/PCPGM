...
//			SetCtrlVal(tabpanel, TABPANEL_LED_DATA_8,FALSE);
	...
	if( (d_in[plc30] != def_in[plc30]) )// BCD data save 
	{
		if( d_in[plc30] )
		{
		  // SetCtrlVal(mainpanel, MAINPANEL_W_LED_3, 1);
		 //  SetCtrlVal(manualctrl, MANUALCTRL_W_LED_3, 1);
