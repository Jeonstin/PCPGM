...
#define  DATAVIEW                         2
#define  DATAVIEW_CLOSE_2                 2       /* control type: command, callback function: Multi_View */
#define  DATAVIEW_CLOSE                   3       /* control type: command, callback function: Close */
#define  DATAVIEW_RESULT                  4       /* control type: table, callback function: (none) */
#define  DATAVIEW_DATA                    5       /* control type: table, callback function: (none) */
#define  DATAVIEW_INPUT_DATA_NUM          6       /* control type: numeric, callback function: inputDataNum */
#define  DATAVIEW_INPUT_START_NUM         7       /* control type: numeric, callback function: inputStartNum */
#define  DATAVIEW_DATA_NUM                8       /* control type: numeric, callback function: (none) */
#define  DATAVIEW_START_NUM               9       /* control type: numeric, callback function: (none) */
#define  DATAVIEW_TOTAL_NUM               10      /* control type: numeric, callback function: (none) */
#define  DATAVIEW_SAVEDATA                11      /* control type: command, callback function: callSaveAsFile */
#define  DATAVIEW_PRINTING                12      /* control type: command, callback function: printingData */
#define  DATAVIEW_REVIEW_COM              13      /* control type: command, callback function: reviewResultData */
#define  DATAVIEW_DATA_FILEOPEN           14      /* control type: pictButton, callback function: Data_FileOpen */
#define  DATAVIEW_REVIEW_COM1             15      /* control type: pictButton, callback function: reviewResultData */
#define  DATAVIEW_SAVEDATA_2              16      /* control type: pictButton, callback function: callSaveAsFile */
#define  DATAVIEW_PRINTING_2              17      /* control type: pictButton, callback function: printingData */
#define  DATAVIEW_TITLE                   18      /* control type: string, callback function: (none) */
#define  DATAVIEW_TEXTMSG_4               19      /* control type: textMsg, callback function: (none) */
#define  DATAVIEW_GRAPH_VIEW              20      /* control type: command, callback function: Graph_View */
#define  DATAVIEW_CSV_SAVE                21      /* control type: command, callback function: Csv_Save */
