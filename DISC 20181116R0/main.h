...
#define  MAINPANEL_TESTTIME_3             93      /* control type: timer, callback function: TestTime3 */
#define  MAINPANEL_TESTTIME_2             94      /* control type: timer, callback function: TestTime2 */
...
#define  MAINPANEL_HHMMSS_4               103     /* control type: textMsg, callback function: (none) */
...
#define  MAINPANEL_HHMMSS_3               119     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_LSL                    120     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_LCL                    121     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_UCL                    122     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_DECORATION_2           123     /* control type: deco, callback function: (none) */
#define  MAINPANEL_USL                    124     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_CH_S2                  125     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_WORK_MODEL_CHAR        126     /* control type: string, callback function: (none) */
#define  MAINPANEL_WORK_NAME              127     /* control type: string, callback function: (none) */
#define  MAINPANEL_STRING_3               128     /* control type: string, callback function: (none) */
#define  MAINPANEL_STRING                 129     /* control type: string, callback function: (none) */
#define  MAINPANEL_CH_S1                  130     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_LAN_TIMER              131     /* control type: timer, callback function: LanTimer */
#define  MAINPANEL_SPLITTER_5             132     /* control type: splitter, callback function: (none) */
...
#define  MAINPANEL_E_STOP_BT              137     /* control type: command, callback function: E_Stop_Bt2 */
#define  MAINPANEL_BZ_STOP                138     /* control type: command, callback function: BZ_Stop2 */
#define  MAINPANEL_AL_RESET               139     /* control type: command, callback function: AL_ReSet2 */
#define  MAINPANEL_ORIGIN_BT              140     /* control type: command, callback function: ORIGIN_bt2 */
...
#define  MAINPANEL_BAR_DATA_13            146     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_11            147     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_4             148     /* control type: string, callback function: (none) */
#define  MAINPANEL_STRING_2               149     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_12            150     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_10            151     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_2             152     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_9             153     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_8             154     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_7             155     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_6             156     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_5             157     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_3             158     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA               159     /* control type: string, callback function: (none) */
#define  MAINPANEL_A_TABLE_2              160     /* control type: table, callback function: (none) */
...
#define  MAINPANEL_LED_MC_2               181     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_2                  182     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED_MC_1               183     /* control type: LED, callback function: (none) */
#define  MAINPANEL_DECORATION_5           184     /* control type: deco, callback function: (none) */
#define  MAINPANEL_MARKLED                185     /* control type: LED, callback function: (none) */
#define  MAINPANEL_CLOSE                  186     /* control type: command, callback function: Close */
...
#define  MAINPANEL_TEXTMSG_18             193     /* control type: textMsg, callback function: (none) */
...
#define  MAINPANEL_PICTURE                197     /* control type: picture, callback function: MeasPointEvent */
#define  MAINPANEL_TEXTMSG_9              198     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_MENU_BT1               199     /* control type: command, callback function: Menu_Bt */
#define  MAINPANEL_A_DATAVIEW             200     /* control type: command, callback function: A_Dataview */
...
#define  MAINPANEL_REFER_BT               203     /* control type: command, callback function: Refer_Bt */
#define  MAINPANEL_ZEROSETUP1             204     /* control type: command, callback function: ZeroSetup0 */
...
#define  MAINPANEL_STATUS_BOX_2           227     /* control type: listBox, callback function: (none) */
...
#define  MAINPANEL_DECORATION_19          230     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_14          231     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_10          232     /* control type: deco, callback function: (none) */
#define  MAINPANEL_MMDDYY                 233     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_DECORATION_13          234     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_4           235     /* control type: deco, callback function: (none) */
#define  MAINPANEL_HHMMSS                 236     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_OPERATE_NO             237     /* control type: ring, callback function: Operate_No */
#define  MAINPANEL_RESET_MC               238     /* control type: command, callback function: Reset_Mc */
#define  MAINPANEL_AUTO_TOG               239     /* control type: textButton, callback function: (none) */
#define  MAINPANEL_MC_STATUS              240     /* control type: textButton, callback function: (none) */
#define  MAINPANEL_TEXTMSG_20             241     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_6              242     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_22             243     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_21             244     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_19             245     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_MSG_SCAN               246     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_24             247     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_SPLITTER_17            248     /* control type: splitter, callback function: (none) */
#define  MAINPANEL_DECORATION_16          249     /* control type: deco, callback function: (none) */
#define  MAINPANEL_O_LED_1                250     /* control type: LED, callback function: (none) */
#define  MAINPANEL_TEXTMSG_26             251     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_SPLITTER_19            252     /* control type: splitter, callback function: (none) */
#define  MAINPANEL_DECORATION_18          253     /* control type: deco, callback function: (none) */
#define  MAINPANEL_MA_LED_1               254     /* control type: LED, callback function: (none) */
#define  MAINPANEL_TEXTMSG_25             255     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_SPLITTER_18            256     /* control type: splitter, callback function: (none) */
#define  MAINPANEL_DECORATION_17          257     /* control type: deco, callback function: (none) */
#define  MAINPANEL_M_LED_1                258     /* control type: LED, callback function: (none) */
#define  MAINPANEL_TEXTMSG_23             259     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_SPLITTER_16            260     /* control type: splitter, callback function: (none) */
#define  MAINPANEL_DECORATION_15          261     /* control type: deco, callback function: (none) */
#define  MAINPANEL_D_LED_1                262     /* control type: LED, callback function: (none) */
#define  MAINPANEL_TEXTMSG_7              263     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_SPLITTER_2             264     /* control type: splitter, callback function: (none) */
#define  MAINPANEL_DECORATION_6           265     /* control type: deco, callback function: (none) */
#define  MAINPANEL_W_LED_1                266     /* control type: LED, callback function: (none) */
#define  MAINPANEL_E_STOP_BT4             267     /* control type: textButton, callback function: E_Stop_Bt2 */
#define  MAINPANEL_TEXTMSG_8              268     /* control type: textMsg, callback function: (none) */
