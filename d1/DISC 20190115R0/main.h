...
#define  DATAPANEL_A_DATAVIEW             11      /* control type: command, callback function: A_Dataview */
#define  DATAPANEL_RESULTVIEW1            12      /* control type: command, callback function: ResultView0 */
#define  DATAPANEL_MODELSETUP1            13      /* control type: command, callback function: ModelSetup0 */
#define  DATAPANEL_ZEROSETUP1             14      /* control type: command, callback function: ZeroSetup0 */
#define  DATAPANEL_DECORATION_9           15      /* control type: deco, callback function: (none) */
#define  DATAPANEL_MANUALCTRL1            16      /* control type: command, callback function: ManualCtrl0 */
...
#define  MAINPANEL_MARK_CNT_NO_2          18      /* control type: numeric, callback function: (none) */
#define  MAINPANEL_MARK_CNT_NO            19      /* control type: numeric, callback function: (none) */
#define  MAINPANEL_TOTALTESTNO            20      /* control type: numeric, callback function: TotalTestNo */
...
#define  MAINPANEL_P11                    85      /* control type: numeric, callback function: MeasPointEvent */
#define  MAINPANEL_LNG                    86      /* control type: numeric, callback function: TotalTestNo */
...
#define  MAINPANEL_TESTTIME_3             92      /* control type: timer, callback function: TestTime3 */
#define  MAINPANEL_TESTTIME_2             93      /* control type: timer, callback function: TestTime2 */
...
#define  MAINPANEL_HHMMSS_4               102     /* control type: textMsg, callback function: (none) */
...
#define  MAINPANEL_HHMMSS_3               118     /* control type: textMsg, callback function: (none) */
...
#define  MAINPANEL_BAR_DATA_13            141     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_11            142     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_4             143     /* control type: string, callback function: (none) */
#define  MAINPANEL_STRING_2               144     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_12            145     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_10            146     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_2             147     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_9             148     /* control type: string, callback function: (none) */
#define  MAINPANEL_BAR_DATA_8             149     /* control type: string, callback function: (none) */
...
#define  MAINPANEL_A_TABLE_4              156     /* control type: table, callback function: A_Table2 */
#define  MAINPANEL_A_TABLE                157     /* control type: table, callback function: A_Table */
#define  MAINPANEL_SPLITTER_15            158     /* control type: splitter, callback function: (none) */
#define  MAINPANEL_SPLITTER               159     /* control type: splitter, callback function: (none) */
#define  MAINPANEL_IMAGE_CAP              160     /* control type: command, callback function: Image_Cap */
#define  MAINPANEL_LAN_TRANS              161     /* control type: command, callback function: Lan_Trans */
#define  MAINPANEL_COMP_VALUE             162     /* control type: numeric, callback function: (none) */
#define  MAINPANEL_RINGCH                 163     /* control type: string, callback function: (none) */
#define  MAINPANEL_TEXTMSG_4              164     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_3              165     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_DECORATION_3           166     /* control type: deco, callback function: (none) */
#define  MAINPANEL_TAB                    167     /* control type: tab, callback function: (none) */
#define  MAINPANEL_DECO_2                 168     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECO_1                 169     /* control type: deco, callback function: (none) */
#define  MAINPANEL_A_WORK3                170     /* control type: LED, callback function: (none) */
#define  MAINPANEL_A_WORK2                171     /* control type: LED, callback function: (none) */
#define  MAINPANEL_A_WORK1                172     /* control type: LED, callback function: (none) */
#define  MAINPANEL_SELECT_MEAS            173     /* control type: textButton, callback function: Select_Meas */
#define  MAINPANEL_SELECT_NG_INT          174     /* control type: textButton, callback function: Sw_Int */
#define  MAINPANEL_LED_MC_3               175     /* control type: LED, callback function: (none) */
#define  MAINPANEL_LED                    176     /* control type: LED, callback function: (none) */
...
#define  MAINPANEL_CLOSE                  182     /* control type: command, callback function: Close */
#define  MAINPANEL_MENU_BT                183     /* control type: command, callback function: Menu_Bt */
#define  MAINPANEL_RESULTVIEW0            184     /* control type: command, callback function: ResultView0 */
#define  MAINPANEL_MODELSETUP0            185     /* control type: command, callback function: ModelSetup0 */
#define  MAINPANEL_ZEROSETUP0             186     /* control type: command, callback function: ZeroSetup0 */
#define  MAINPANEL_MANUALCTRL0            187     /* control type: command, callback function: ManualCtrl0 */
#define  MAINPANEL_MARKING_CHAR           188     /* control type: string, callback function: (none) */
#define  MAINPANEL_TEXTMSG_18             189     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_BF_MARKING             190     /* control type: string, callback function: (none) */
#define  MAINPANEL_DECORATION_7           191     /* control type: deco, callback function: (none) */
#define  MAINPANEL_TEXTMSG_5              192     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_PICTURE                193     /* control type: picture, callback function: MeasPointEvent */
#define  MAINPANEL_TEXTMSG_9              194     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_MENU_BT1               195     /* control type: command, callback function: Menu_Bt */
#define  MAINPANEL_A_DATAVIEW             196     /* control type: command, callback function: A_Dataview */
#define  MAINPANEL_RESULTVIEW1            197     /* control type: command, callback function: ResultView0 */
#define  MAINPANEL_MODELSETUP1            198     /* control type: command, callback function: ModelSetup0 */
#define  MAINPANEL_ZEROSETUP1             199     /* control type: command, callback function: ZeroSetup0 */
...
#define  MAINPANEL_STATUS_BOX_2           222     /* control type: listBox, callback function: (none) */
#define  MAINPANEL_STATUS_BOX             223     /* control type: listBox, callback function: (none) */
#define  MAINPANEL_DECORATION             224     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_10          225     /* control type: deco, callback function: (none) */
#define  MAINPANEL_MMDDYY                 226     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_DECORATION_12          227     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_11          228     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_13          229     /* control type: deco, callback function: (none) */
#define  MAINPANEL_DECORATION_4           230     /* control type: deco, callback function: (none) */
#define  MAINPANEL_HHMMSS                 231     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_OPERATE_NO             232     /* control type: ring, callback function: Operate_No */
#define  MAINPANEL_RESET_MC               233     /* control type: command, callback function: Reset_Mc */
#define  MAINPANEL_PICTURE_3              234     /* control type: picture, callback function: (none) */
#define  MAINPANEL_AUTO_TOG               235     /* control type: textButton, callback function: (none) */
#define  MAINPANEL_MC_STATUS              236     /* control type: textButton, callback function: (none) */
#define  MAINPANEL_TEXTMSG_20             237     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_6              238     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_22             239     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_21             240     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_TEXTMSG_19             241     /* control type: textMsg, callback function: (none) */
#define  MAINPANEL_MSG_SCAN               242     /* control type: textMsg, callback function: (none) */
